...
const CountryDetail: React.FC<CountryDetailMobileInterface> = ({ lightModeEnabled }) => {
    ...
    return (
        <div className={styles.container} style={lightModeEnabled ? { backgroundColor: COLORS.LIGHT_MODE_BACKGROUND } : { backgroundColor: COLORS.DARK_MODE_BODY_BACKGROUND }}>
            ...
            {displayCountry ? <div style={{ color: lightModeEnabled ? COLORS.LIGHT_MODE_TEXT : COLORS.DARK_MODE_TEXT, padding: '35px 0px' }}>

                <img style={{ marginBottom: '20px' }} src={displayCountry?.flags.png}></img>
